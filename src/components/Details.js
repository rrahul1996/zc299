...
class Details extends React.Component {
    ...
    componentDidMount () {
      ...
      axios({
        method: 'GET',
        url: `https://gentle-ridge-33068.herokuapp.com/restaurant/${restaurant}`,
    ...
    GetMenuItems = () => {
        ...
        axios({
            method: 'GET',
            url: `https://gentle-ridge-33068.herokuapp.com/menuitems/${restaurantId}`,
            headers: { 'Content-Type': 'application/json' }
        })
            .then(response => {
    ...
    getData = (data) => {
        return fetch(`https://gentle-ridge-33068.herokuapp.com/payment`, {
            method: "POST",
            headers: {
    ...
    render () {
        ...
        return (
            <div>
                <div>
                    <img src={`./${restaurant.image}`} alt="No Img, Sorry for the Inconvinience" width="100%" height="350px" />
                                            ...
                                            <div className="card" style={{ width: '43rem', margin: 'auto' }}>
                                                <div className="row" style={{ paddingLeft: '10px', paddingBottom: '10px' }}>
                                                    ...
                                                    <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                        <img className="card-img-center title-img" src={`../${item.image}`} alt="Nothing" style={{
                                                            height: '75px',
                                                            width: '75px',
                                                            borderRadius: '20px',
                                                            marginTop: '12px',
                ...
                >
                    <div>
                        <div class="glyphicon glyphicon-remove" style={{ float: 'right', fontSize : '15px', marginBottom: '15px', marginRight: '15px',  marginTop: '15px' }}
